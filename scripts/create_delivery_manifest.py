...
def run(args: argparse.Namespace) -> int:
    ...
    manifest = {
        ...
        "known_limitations": ([
            ...
            "P3E.2 CCPP real audit completed 8/8 without threshold crossing; this non-rejection is not a posterior-adequacy certificate",
        ...
        "claim_boundaries": [
            ...
            "P3E.2 real-audit result supports protocol-valid non-rejection against the registered discrepancy alternative only; real posterior adequacy remains unproven",
